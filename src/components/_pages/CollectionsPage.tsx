...
import {
  fetchCollections,
  updateInputCollections,
  checkInputCollections,
...
const CollectionsPage = () => {
  ...
  const all: ICollections = useSelector(
  ...
  const cursorIsOnElement: ICursor = useSelector(
    (state: CursorState) => state.cursor
  );
