...
const Cursor = forwardRef<HTMLDivElement, Props>(({ aniClass }, ref) => {
    const cursorElement: ICursor = useSelector((state: CursorState) => state.cursor);
    const cursorPosition = cursorElement.cursorPosition;
