                        ...
                        {items.map((el, index) => (
                            <SwiperSlide key={index + 'slide'} className='swiper-slide'>
                                {<div className="swiper__slide">
                                    <figure className='swiper__image-wrapper' onMouseMove={(event) => detectCursorFunc(event)} onMouseEnter={() => dispatch(enterCursor(true))} onMouseLeave={() => dispatch(leaveCursor(true))}>
                                    ...
                                    <div className='swiper__content'>
                                        <h2 className='title-h1 swiper__title' onMouseMove={(event) => detectCursorFuncEye(event)} onMouseEnter={() => dispatch(enterCursor(true))} onMouseLeave={() => dispatch(leaveCursor(true))}>
